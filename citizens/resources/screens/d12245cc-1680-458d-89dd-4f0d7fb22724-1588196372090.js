jQuery("#simulation")
  ...
  .on("rotateright", ".s-d12245cc-1680-458d-89dd-4f0d7fb22724 .rotateright", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  "action": "jimRotate",
                  "parameter": {
                    "target": [ "#s-Button_2","#s-Text_2","#s-Text_1","#s-Image_1","#s-Empty_screen_color_top","#s-Button_1","#s-Line_1","#s-Text_4","#s-Text_3" ],
                    "angle": {
                      "type": "rotateto",
                      "value": "0"
                    }
